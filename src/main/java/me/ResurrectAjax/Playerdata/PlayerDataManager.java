...
public class PlayerDataManager {
    ...
    public PlayerDataManager(SkyBlock plugin) {
        ...
        for (Player all : Bukkit.getOnlinePlayers()) {
            ...
            plugin.getPlayerDataManager().loadPlayerData(all);
            
            if (!plugin.getPlayerDataManager().hasPlayerData(all)) {
            	plugin.getPlayerDataManager().createPlayerData(all);
            	plugin.getPlayerDataManager().loadPlayerData(all);
            }
            
            plugin.getPlayerDataManager().storeIsland(all);
